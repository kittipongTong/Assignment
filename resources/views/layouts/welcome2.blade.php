...
<body>
    ...
    <div class="slider_area">
      <div class="single_slider d-flex align-items-cente ">
      <div  class="single_slider  d-flex align-items-center slider_bg_1-1024x485.jpg">

            <div class="container">
                <img  class="row" src="finloans/img/slider_bg_1-1024x485.jpg" alt="">
                <!-- <div class="row align-items-center justify-content-center"> -->
                    <!-- <div class="col-lg-7 col-md-6">
                        <div class="slider_text">

                            <h3 class="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".1s">ระบบมอบหมายงานสำหรับผู้บริหาร</h3>
